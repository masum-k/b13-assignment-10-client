...
// 1. Separate the main form logic into its own component
function SigninForm() {
            ...
            <form onSubmit={handleSignin} className="flex flex-col gap-5 mt-6">
                ...
                <TextField isRequired name="password" className="flex flex-col gap-1.5">
                    <div className="flex items-center justify-between">
                        ...
                        <Link href="/auth/forgot-password" className="text-xs text-red-600 hover:text-red-700 hover:underline font-medium">
                            Forgot password?
                        </Link>
                    </div>
                    <InputGroup className="flex items-center gap-2 border border-gray-300 rounded-lg px-3 bg-white transition-colors h-11">
...
// 2. Export default page component wrapped with Suspense boundary
