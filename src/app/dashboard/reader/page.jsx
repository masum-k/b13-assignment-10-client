        ...
        <div className="min-h-screen bg-gray-50 font-sans text-gray-900 pb-16">
            ...
            <header className="bg-white border-b border-gray-200 sticky top-0 z-20">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
                    <Link href="/" className="inline-flex items-center gap-1 text-xl font-bold tracking-tight text-gray-900">
                        BOOK
                        <span className="text-red-600 text-2xl font-black">W</span>
                        ORM
                    </Link>
